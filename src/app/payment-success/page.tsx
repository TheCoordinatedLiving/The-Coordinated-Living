        ...
        <div className="text-center">
          ...
          <div className="bg-red-500/20 border border-red-500/30 rounded-lg p-4 mb-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className={`${roboto.className} text-red-100 text-sm font-medium mb-1`}>Important Notice</p>
                <p className={`${roboto.className} text-red-100 text-xs leading-relaxed`}>
