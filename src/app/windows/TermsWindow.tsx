...
const TermsWindow = ({ onClose, isActive, onFocus }: TermsWindowProps) => {
  ...
  return (
    <div
      ref={windowRef}
      className="absolute inset-x-0 top-0 bottom-16 flex items-center justify-center opacity-0 pointer-events-none"
      style={{ zIndex: isActive ? 50 : 40 }}
    >
      <div
        className="w-[90vw] h-[90vh] max-w-[1200px] bg-gray-900 rounded-lg shadow-2xl flex flex-col pointer-events-auto"
        onClick={(e) => {
          e.stopPropagation();
          onFocus();
        }}
